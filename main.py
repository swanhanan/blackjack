...
def play_game():
    ...
    # The score will need to be rechecked with every new card drawn and the checks need to be repeated until the game
    # ends.
    ...
    while not is_game_over:
        ...
        if user_score == 0 or computer_score == 0 or user_score > 21:
            ...
            # If the game has not ended, ask the user if they want to draw another card. If yes, then add another
